  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        ...
        "Payments are processed via Razorpay, supporting UPI, cards, and net banking. Payment integration is currently disabled for development.",
    },
    {
            ...
            <Card className="p-8 shadow-lg bg-white/10 backdrop-blur-lg border border-white/20 dark:bg-gray-800/10 dark:border-gray-700/20 transition-transform duration-300 hover:scale-[1.02] hover:shadow-2xl">
              <CardContent className="p-0 flex flex-col items-center">
                ...
                <ul className="space-y-3 text-left w-full">
                  ...
                  <li className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                    <Check className="w-5 h-5 text-green-500" /> Secure payments via Razorpay
